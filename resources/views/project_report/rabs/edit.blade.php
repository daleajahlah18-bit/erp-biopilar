...
@section('page_title', 'Edit RAB: ' . $rab->rab_name)

@section('content')
<div class="row">
    <div class="col-12">
        <form action="{{ route('rabs.update', $rab->id) }}" method="POST" id="rabForm">
            @csrf
            @method('PUT')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="project_id" class="form-select select2" required>
                                ...
                                @foreach($projects as $project)
                                    <option value="{{ $project->id }}" {{ $rab->project_id == $project->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="rab_name" class="form-control" value="{{ $rab->rab_name }}" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span class="me-4 fw-bold fs-5 text-success">Grand Total: Rp <span id="grandTotalDisplay">{{ number_format($rab->total_amount, 2, ',', '.') }}</span></span>
            ...
            <div class="d-flex justify-content-end mb-5">
                ...
                <button type="submit" class="btn btn-success" id="btnSave">Update RAB</button>
            </div>
        </form>
    </div>
</div>
