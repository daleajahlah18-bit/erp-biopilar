@extends('layouts.app')
@section('title', 'Create Survey Report')
@section('page_title', 'Create Survey Report')

@section('content')
<div class="row">
    <div class="col-12">
        <form action="{{ route('survey-reports.store') }}" method="POST" id="surveyReportForm" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="survey_location" class="form-control" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">PIC Client</label>
                            <input type="text" name="pic_client" class="form-control">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="survey_date" class="form-control" value="{{ date('Y-m-d') }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="opening_description" class="form-control" rows="3" required>{{ $defaultOpening }}</textarea>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Closing Description</label>
                            <textarea name="closing_description" class="form-control" rows="3">{{ $defaultClosing }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end mb-5">
                ...
                <button type="submit" class="btn btn-success" id="btnSave">Save Survey Report</button>
            </div>
        </form>
    </div>
</div>
