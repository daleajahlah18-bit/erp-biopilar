                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="document_location" class="form-control @error('document_location') is-invalid @enderror" value="{{ old('document_location', $reportPhase->document_location) }}" placeholder="Contoh: Tangerang">
