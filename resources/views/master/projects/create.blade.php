...
<div class="row">
    <div class="col-lg-8">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('master.projects.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="person_in_charge" class="form-control @error('person_in_charge') is-invalid @enderror" value="{{ old('person_in_charge') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="project_status" class="form-select @error('project_status') is-invalid @enderror" required>
                                <option value="Draft" {{ old('project_status') == 'Draft' ? 'selected' : '' }}>Draft</option>
                                <option value="On Going" {{ old('project_status') == 'On Going' ? 'selected' : '' }}>On Going</option>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="project_address" class="form-control @error('project_address') is-invalid @enderror" rows="2">{{ old('project_address') }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="date" name="client_po_date" class="form-control @error('client_po_date') is-invalid @enderror" value="{{ old('client_po_date') }}">
                            @error('client_po_date') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Project Start Date</label>
                            <input type="date" name="project_start_date" class="form-control @error('project_start_date') is-invalid @enderror" value="{{ old('project_start_date') }}">
                            @error('project_start_date') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Project End Date</label>
                            <input type="date" name="project_end_date" class="form-control @error('project_end_date') is-invalid @enderror" value="{{ old('project_end_date') }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" id="project_value" name="project_value" class="form-control @error('project_value') is-invalid @enderror" value="{{ old('project_value', 0) }}" min="1" step="0.01" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="field_of_work" class="form-control @error('field_of_work') is-invalid @enderror" value="{{ old('field_of_work') }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="executor_name" class="form-control @error('executor_name') is-invalid @enderror" value="{{ old('executor_name') }}">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Simpan Project</button>
                    </div>
                </form>
            </div>
        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function addRow() {
        ...
        tr.innerHTML = `
            ...
            <td>
                <select name="payment_terms[${rowIndex}][top_type]" class="form-select" required>
                    ${optionsHtml}
                </select>
            </td>
            <td>
