        ...
        <form action="{{ route('master.products.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="product_type" class="form-select @error('product_type') is-invalid @enderror" required>
                    ...
                    <option value="Bahan Baku" {{ old('product_type') == 'Bahan Baku' ? 'selected' : '' }}>Bahan Baku</option>
                    <option value="Bahan Jadi" {{ old('product_type') == 'Bahan Jadi' ? 'selected' : '' }}>Bahan Jadi</option>
                    <option value="Bill of Material" {{ old('product_type') == 'Bill of Material' ? 'selected' : '' }}>Bill of Material</option>
                </select>
            ...
            <div class="mb-3">
                ...
                <select name="engineering_category" class="form-select @error('engineering_category') is-invalid @enderror" required>
                    ...
                    <option value="Civil" {{ old('engineering_category') == 'Civil' ? 'selected' : '' }}>Civil</option>
                    <option value="Mechanical" {{ old('engineering_category') == 'Mechanical' ? 'selected' : '' }}>Mechanical</option>
                    <option value="Electrical" {{ old('engineering_category') == 'Electrical' ? 'selected' : '' }}>Electrical</option>
                </select>
